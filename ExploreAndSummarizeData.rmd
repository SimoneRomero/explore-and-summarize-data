...
For pH feature, the boxplots show that a high pH scale can produce low quality wines. However it is not clear the which is the ideal pH to produce high quality wines, since the values for average and high quality wines are very similar (3.31 and 3.27, respectively).
